...
export class LoginComponent implements OnInit {
    constructor(private requestMaker : RequestMaker, private userAuthService : UserAuthService, private router : Router) {}
    ...
    login(loginForm : NgForm) {
        ...
        var request = this.requestMaker.getAuthRequest(URI.TOKEN_URI, data, authHeaders);
